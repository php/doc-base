...
const LOOSE_SKIP_REVCHECK = true; // See https://github.com/php/doc-base/pull/132 , issue 1
const FIXED_SKIP_REVCHECK = true; // See https://github.com/php/doc-base/pull/132 , issue 2
...
if ( LOOSE_SKIP_REVCHECK ) { $description = <<<'TEXT'
...
do not cause files modifications being untracked on translations.

TEXT; }



if ( FIXED_SKIP_REVCHECK ) { $description = <<<'TEXT'
