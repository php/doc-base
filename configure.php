...
// xml_partial_output
// xml_validate()               done
// phd auxiliary files          moved to php/phd (genphdfiles.php)
...
// PhD auxiliary files (version.xml, sources.xml, fileModHistory.php) are now
// generated by php/phd (genphdfiles.php), from the phd-conf.json handoff below.
...
// Serialize the state PhD needs to regenerate its auxiliary files
// (version.xml, sources.xml, fileModHistory.php) into doc-base/temp/phd-conf.json,
// so that generation can move out of configure.php into php/phd (genphdfiles.php).
